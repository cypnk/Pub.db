...
INSERT INTO languages (
	iso_code, label, eng_name, lang_group
) VALUES 
( 'abk', 'Аԥсуа', 'Abkhazian', 'ab' ),
( 'arb', 'العربية', 'Arabic', 'ar' ),
( 'bel', 'беларуская', 'Belarusian', 'be' ),
( 'ben', 'বাংলা', 'Bengali', 'bn' ),
( 'bod', 'བོད་ཡིག', 'Tibetan', 'bo' ),
( 'cat', 'Català', 'Catalan', 'ca' ),
( 'ces', 'Čeština', 'Czech', 'cs' ),
( 'ckb', 'سۆرانی', 'Central Kurdish', 'ku' ),
( 'cmn', '普通话', 'Mandarin', 'zh' ),
...
( 'epo', 'Esperanto', 'Esperanto', 'eo' ),
( 'est', 'Eesti', 'Estonian', 'et' ),
( 'fas', 'فارسی', 'Persian', 'fa' ),
( 'fin', 'Suomi', 'Finnish', 'fi' ),
( 'fra', 'Français', 'French', 'fr' ),
( 'guj', 'ગુજરાતી', 'Gujarati', 'gu' ),
( 'heb', 'עִבְרִית', 'Hebrew', 'he' ),
( 'hin', 'हिन्दी', 'Hindi', 'hi' ),
( 'hin-awd', 'अवधी', 'Awadhi Hindi', 'hi' ),
( 'hin-bho', 'भोजपुरी', 'Bhojpuri Hindi', 'hi' ),
( 'hin-mar', 'मारवाड़ी', 'Marwari Hindi', 'hi' ),
( 'hin-bra', 'ब्रज', 'Braj Hindi', 'hi' ),
( 'hrv', 'Hrvatski', 'Croatian', 'hr' ),
( 'hun', 'Magyar', 'Hungarian', 'hu' ),
( 'hye', 'Հայերեն', 'Armenian', 'hy' ),
( 'ina', 'Interlingua', 'Interlingua', 'ia' ),
( 'gle', 'Gaeilge', 'Irish', 'ga' ),
( 'ita', 'Italiano', 'Italian', 'it' ),
( 'jpn', '日本語', 'Japanese', 'ja' ),
( 'jpn-fuk', '福岡弁', 'Fukuoka Japanese', 'ja' ),
( 'jpn-hak', '博多弁', 'Hakata Japanese', 'ja' ),
( 'jpn-kan', '関西弁', 'Kansai Japanese', 'ja' ),
...
( 'kfa', 'ಕೊಡವ', 'Kodava', 'kfa' ),
( 'khm', 'ខ្មែរ', 'Khmer', 'km' ),
( 'khm-phn', 'ភាសាខ្មែរក្រុង', 'Phnom Penh Khmer', 'km' ),
( 'khm-nor', 'ភាសាខ្មែរខាងជើង', 'Northern Khmer', 'km' ),
( 'khm-sou', 'ភាសាខ្មែរខាងត្បូង', 'Southern Khmer', 'km' ),
( 'khm-kar', 'ភាសាខ្មែរការបូរ', 'Cardamom Khmer', 'km' ),
...
( 'lao', 'ພາສາລາວ', 'Lao', 'lo' ),
( 'lav', 'Latviešu valoda', 'Latvian', 'lv' ),
( 'lit', 'Lietuvių', 'Lithuanian', 'lt' ),
( 'mal', 'മലയാളം', 'Malayalam', 'ml' ),
( 'mar', 'मराठी', 'Marathi', 'mr' ),
( 'mkd', 'македонски', 'Macedonian', 'mk'),
( 'mni', 'ꯃꯩꯇꯩꯂꯣꯟ', 'Meitei', 'mni' ),
( 'mon', 'Монгол хэл', 'Mongolian', 'mn' ),
( 'mri', 'te reo Māori', 'Maori', 'mi' ),
( 'msa', 'Bahasa Melayu', 'Malay', 'ms' ),
( 'mya', 'မြန်မာစာ', 'Burmese', 'my' ),
( 'nep', 'नेपाली', 'Nepali', 'ne' ),
( 'nld', 'Nederlands', 'Dutch', 'nl' ),
( 'nor', 'Norsk', 'Norwegian', 'nn' ),
( 'oji', 'ᐊᓂᔑᓇᐯᒧᐎᓐ', 'Ojibwa', 'oj' ),
( 'ori', 'ଓଡ଼ିଆ', 'Oriya', 'or' ),
...
( 'slv', 'Slovenščina', 'Slovenian', 'sl' ),
( 'sin', 'සිංහල', 'Sinhalese', 'si' ),
( 'srp', 'Srpski', 'Serbian', 'sr' ),
( 'spa', 'Español', 'Spanish', 'es' ),
( 'sqi', 'Shqip', 'Albanian', 'sq' ),
...
( 'tha', 'ภาษาไทย', 'Thai', 'th' ),
( 'tha-isan', 'ภาษาอีสาน', 'Isan Thai', 'th' ),
( 'tuk', 'Түркменче', 'Turkmen', 'tk' ),
( 'tur', 'Türkçe', 'Turkish', 'tr' ),
( 'ukr', 'Українська', 'Ukrainian', 'uk' ),
( 'urd', 'اردو', 'Urdu', 'ur' ),
( 'urd-dakh', 'دکنی', 'Dakhni Urdu', 'ur' ),
( 'uzb', 'Ўзбек', 'Uzbek', 'uz' ),
( 'vie', 'Tiếng Việt', 'Vietnamese', 'vi' ),
( 'xal', 'Хальмг', 'Kalmyk', 'xal' ),
( 'yid', 'אידיש', 'Yiddish', 'yi' ),
( 'yue', '粤语', 'Cantonese', 'zh' ),
( 'yue-gz', '广州话', 'Guangzhou Cantonese', 'zh' ),
( 'yue-hk', '香港粤语', 'Hong Kong Cantonese', 'zh' ),
( 'yue-tsh', '台山话', 'Taishanese Cantonese', 'zh' ),
( 'yue-xg', '新会话', 'Xinhui Cantonese', 'zh' ),
( 'yor', 'Yorùbá', 'Yoruba', 'yo' ),
( 'zho', '中文', 'Chinese', 'zh' );-- --

-- Language and region prefrerence to ISO-code map
CREATE TABLE lang_regions (
	iso_code TEXT NOT NULL COLLATE NOCASE, 
	region_code TEXT NOT NULL COLLATE NOCASE, 
	
	PRIMARY KEY ( iso_code, region_code )
);-- --

INSERT INTO lang_regions( iso_code, region_code )
VALUES
( "cmn", "cmn" ), 
( "cmn", "cmn-bj" ), 
( "cmn", "cmn-nm" ), 
...
CREATE INDEX idx_user_langcode ON user_meta ( langcode );
CREATE INDEX idx_user_tz_offset ON user_meta ( tz_offset );
...
CREATE TABLE login_attempts ( 
	...
	ip_address TEXT NOT NULL COLLATE NOCASE,
	last_attempt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	blocked_until TIMESTAMP,
	failed_count INTEGER DEFAULT 1
);
CREATE INDEX idx_login_ip ON login_attempts ( ip_address );
CREATE INDEX idx_login_attempt ON login_attempts ( last_attempt );
CREATE INDEX idx_login_blocked ON login_attempts ( blocked_until );
